...
public class PaperVerticalLayout extends PaperLayout{
    ...
    public PaperVerticalLayout(Context context) {
        super(context);
        init(context,null, 0);
    }

    public PaperVerticalLayout(Context context, AttributeSet attrs) {
        super(context, attrs);
        init(context,attrs, 0);
    }

    public PaperVerticalLayout(Context context, AttributeSet attrs, int defStyle) {
